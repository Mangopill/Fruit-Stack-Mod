...
public class GlutinousRiceItem extends ItemNameBlockItem
{
	public GlutinousRiceItem(Block block, Properties properties) {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (result.equals(InteractionResult.FAIL)) {
			...
			if (player != null && context.getClickedFace().equals(Direction.UP) && (targetState.is(BlockTags.DIRT) || targetState.getBlock() instanceof FarmBlock)) {
				player.displayClientMessage(TextUtils.getTranslation("block.glutinous_rice.invalid_placement"), true);
			}
		}
